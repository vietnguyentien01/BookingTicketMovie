...
export default function Detail(props) {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-8 py-40 blur-0 w-2/3">
        <div
          className="flex max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 content-center col-span-6"
          style={{ height: "410px" }}
        >
        ...
        <div className="flex flex-col justify-center col-span-6">
          <div
            className={`c100 p${filmDetail.danhGia * 10} medium self-center`}
          >
        ...
        <div className="mt-9 w-full col-span-12 bg-white">
                      ...
                      tab={
                        <div className="flex flex-row py-2">
                          <img
                            ...
                            style={{ minWidth: "42px" }}
                          ></img>
                          <div className="self-center">{htr.tenHeThongRap}</div>
                        </div>
                      }
                      key={index}
                    >
